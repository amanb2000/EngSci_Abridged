...
To recap Section~\ref{sec:single_boundary}: We derived an optimal estimator of $\mathbf x^*$ based on noisy i.i.d. measurements $\mathbf X(1), \dots, \mathbf X(t) ~ \mathcal N(\mathbf x^*, \mathbf I_d)$ in Lemma~\ref{}. 

for an optimal estimator of classification output $y(\mathbf x^*)$ based on noisy i.i.d. measurements $\mathbf X(1), \dots, \mathbf X(t) ~ \mathcal N(\mathbf x^*, \mathbf I_d)$. 
